<script lang="ts">
    ...
    const quotes: Quote[] = [
        ...
        { text: 'You can never get a cup of tea large enough or a book long enough to suit me.', author: 'C.S. Lewis' },
        {
            ...
            author: 'Groucho Marx, The Essential Groucho',
        },
        {
        ...
        {
            text: 'Live the life of your dreams: be brave enough to live the life of your dreams...',
            author: 'Roy T. Bennett, The Light in the Heart',
        },
        {
            text: 'Do not be pushed around by the fears in your mind. Be led by the dreams in your heart.',
            author: 'Roy T. Bennett, The Light in the Heart',
        },
        {
            text: 'Attitude is a choice. Happiness is a choice. Optimism is a choice. Kindness is a choice.',
            author: 'Roy T. Bennett, The Light in the Heart',
        },
        { text: 'Do one thing every day that scares you.', author: 'Eleanor Roosevelt' },
        {
            text: 'And now here is my secret: It is only with the heart that one can see rightly.',
        ...
        {
            text: 'If you don’t read the newspaper, you are uninformed. If you do read the newspaper, you are misinformed.',
            author: 'Mark Twain',
        },
        {
